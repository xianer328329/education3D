<template>
 	<div class="">
 		<el-table  :data="lists" stripe max-height="500" v-loading="loading">
		    <el-table-column prop="alarmTypeName" label="告警类型" :show-overflow-tooltip="true"> </el-table-column>
			<el-table-column prop="carPlate" label="车牌" width="150" :show-overflow-tooltip="true"> </el-table-column> 
			...
			<el-table-column prop="postion" label="道闸" :show-overflow-tooltip="true"> </el-table-column>
		</el-table>
...
<script>
	...
	export default {
		...
		mounted(){
			var vm=this;
			this.bus.$off('getAlarmDetail').$on('getAlarmDetail',function(res){
		...
		methods:{
			...
			getData(){
				...
				this.$axios.post('traffic/pass/alarmInformation/'+UNITID,params).then(function(res){
