<template>
 	<div class="">
 		<el-table  :data="lists" stripe max-height="500">
		    <el-table-column prop="carPlate" label="车牌" :show-overflow-tooltip="true"></el-table-column>
			<el-table-column prop="status" label="是否同意协助" width="150" :show-overflow-tooltip="true"> </el-table-column>
			<el-table-column prop="handleTime" label="处理时间" width="180" :show-overflow-tooltip="true"> </el-table-column>
...
<script>
	...
	export default {
		...
		mounted(){
			var vm=this;
			this.bus.$off('getReceiveDetail').$on('getReceiveDetail',function(res){
		...
		methods:{
			...
			getData(){
				...
				this.$axios.post('traffic/pass/acceptDetailsList/'+UNITID,params).then(function(res){
